...
class VinxNode(BaseHILTest):
    """
    Управление нодой /visualization/vinx.
    """

    NODE_NAME = "/visualization/vinx"
    PROCESS_NAME = "vinx_node"
    EXPECTED_ERRORS = {}

    def __init__(self):
        super().__init__(node_name="vinx_node", timeout=15)
